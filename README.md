...
| [`Albums-CV`](https://github.com/pzae/Yandex_Practicum_workshops/tree/main/Albums-CV) | Создание модели для определения жанра по изображению обложки музыкального альбома | `cv`, `faiss`, `pytorch`, `torchvision` |
